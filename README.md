...
- Choose a **theme** from the toolbar dropdown: **Light** (default), **Dark**, **High Contrast Light**, **High Contrast Dark**, **Light – Large Text**, **Dark – Large Text**, **Slate Blue** (navy/steel-blue palette with vibrant labels), or **Slate Blue – Large Text**; the selection is remembered between sessions and takes effect immediately without a restart
