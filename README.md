...
- Window size, position, splitter position, selected folder, selected photo/video, and Photos/Videos pane scroll position are all remembered between sessions
